...
;;; Tests for Problem 8
(begin (print 1) 1/0 (car '(1 2 3)))
; expect 1 ; Error

(begin (define a 3) (define b 2) (+ a b))
; expect 5
...
(((lambda (f) (lambda (h) (+ h f))) 1)2)
; expect 3

;;; Tests for Problem 10-12
(define (times_a a)
        (define (add x y) (+ x y))
        (* a (add 1 2)))
; expect times_a
...
(define y 2)
(define f (mu() (+ x y)))
(define (g x y) (define x 5) (define y 6) (f))
(g 1 2)
; expect 11
; END PROBLEM 0
